    ...
    <>
      ...
      <section className="grid items-center gap-12 md:grid-cols-[minmax(0,3fr)_minmax(0,2fr)]">
        ...
        <div className="space-y-6">
          ...
          {/* Drei „Chips“ */}
          <div className="flex flex-wrap gap-2 pt-3 text-sm text-slate-300">
          ...
          <div className="absolute inset-0 overflow-hidden rounded-[1.7rem] border border-slate-800/80 bg-slate-900/80 shadow-xl shadow-slate-950/70">
            <div className="relative flex h-full flex-col justify-between p-6">
              <div className="flex items-center justify-between text-xs text-slate-200">
                ...
                <span className="rounded-full bg-emerald-500/20 px-2 py-0.5 text-xs font-semibold tracking-[0.18em] text-emerald-300">
                  Online
                </span>
              </div>

              <div className="space-y-4 pt-3 text-xs text-slate-100">
                <MetricRow
                  label="Schlaf-Qualität"
                  value="86%"
              ...
              <p className="mt-3 text-xs text-slate-300">
                „Trainiere nicht nur für heute – trainiere für die nächsten 30
                Jahre.“
              </p>
            </div>
          </div>
      ...
      <section className="border-t border-slate-800/60 pt-10">
        <div className="flex flex-wrap items-end justify-between gap-4">
          ...
          <a
            href="/courses"
            className="text-sm font-semibold tracking-[0.18em] text-cyan-300 hover:text-cyan-200"
          >
            Alle Programme →
          </a>
        </div>
      ...
      <section className="grid gap-10 md:grid-cols-[minmax(0,3fr)_minmax(0,2.5fr)] pt-4">
        ...
        <div className="rounded-2xl border border-slate-800 bg-slate-900/70 p-6 text-base text-slate-300">
          ...
          <a
            href="/qa"
            className="mt-4 inline-flex text-sm font-semibold tracking-[0.18em] text-cyan-300 hover:text-cyan-200"
          >
            Zum Q&amp;A-Bereich →
          </a>
        </div>
